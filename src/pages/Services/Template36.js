  ...
  return (
    <div>
      ...
      <main>
        ...
        <div className="vnhdfiuvhfdbfd" style={{backgroundImage: "url(./images/d.png)"}}>
          <div className="custom-container">
        ...
        <div className="vhfdhhgfdfdg">
          <div className="custom-container">
            <div className="hdbchbd55">
              <div className="row">
                <div className="col-lg-6">
                  <div className="gbgfhgf">
