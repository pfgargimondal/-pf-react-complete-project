  ...
  return (
    <div>
      ...
      <main>
        ...
        <div className="fghsdfgsdfgdfg">
          <div className="custom-container">
            <div className="fghjkdfghdf">
              <div className="row">
                <div className="col-lg-6">
                  <div className="dfbhdfdf6528">
                    <div className="fghsdfsdf">
                    ...
                    <div className="fdfdfg">
                      <h4>
                        {serviceResponse.data?.third_section_title_one &&
                          serviceResponse.data.third_section_title_one}
                      </h4>
                      <div
                        dangerouslySetInnerHTML={{
                ...
                <div className="col-lg-6">
                  <div className="dfbhdfdf6528">
                    ...
                    <div className="fdfdfg">
                      <h4>
                        {serviceResponse.data?.third_section_title_two &&
                          serviceResponse.data.third_section_title_two}
                      </h4>
                      <div
                        dangerouslySetInnerHTML={{
