        ...
        <div className={styles.dfgjhfgd}>
          ...
          <div className={`${styles.dbfghsdf} col-lg-6`}>
            {serviceResponse.data?.banner_image && (
              <img src={`${serviceResponse.image_url}/Templete_44/${serviceResponse.data.banner_image}`} alt="" />
            )}
          </div>
        </div>
      </div>
                ...
                <div className={styles.dfbhdfdf6528}>
                  <div className={styles.fghsdfsdf}>
                    {serviceResponse.data?.third_section_image_one && (
                      <img src={`${serviceResponse.image_url}/Templete_44/${serviceResponse.data.third_section_image_one}`} alt="" />
                    )}
                  </div>
                  <div className={styles.fdfdfg}>
                    ...
                    <div
                      dangerouslySetInnerHTML={{
                        __html: serviceResponse.data?.third_section_description_one,
                      }}
                    />
                  </div>
                </div>
                ...
                <div className={styles.dfbhdfdf6528}>
                  <div className={styles.fghsdfsdf}>
                    {serviceResponse.data?.third_section_image_two && (
                      <img src={`${serviceResponse.image_url}/Templete_44/${serviceResponse.data.third_section_image_two}`} alt="" />
                    )}
                  </div>
                  <div className={styles.fdfdfg}>
                    ...
                    <div
                      dangerouslySetInnerHTML={{
                        __html: serviceResponse.data?.third_section_description_two,
                      }}
                    />
                  </div>
                </div>
              ...
              <div className="col-lg-6">
                <div className={styles.cfbgjhcfdf}>
                  {serviceResponse.data?.fifth_section_image && (
                    <img src={`${serviceResponse.image_url}/Templete_44/${serviceResponse.data.fifth_section_image}`} alt="" />
                  )}
                </div>
              </div>
            </div>
