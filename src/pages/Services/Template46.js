  ...
  return (
    <div>
      ...
      <main>
        ...
        <div className="dbfsdbgdfgdfg">
          <div className="container">
            <div className="fdfgdfgfg">
              <h2>
            ...
            <div className="fgfhdfgdfg">
              <div className="row">
                <div className="col-lg-6">
                  <div className="dfbdfhgdfg">
                    <div className="dfbdf">
                ...
                <div className="col-lg-6">
                  <div className="fhgdfgdf">
                    <div className="row">
                      <div className="col-lg-2">
                        <div className="sdfbsdf">
