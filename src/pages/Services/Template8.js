  ...
  return (
    ...
    <div className={`${styles.dfbghdfgdfgdf} ${styles.sfmlkdfdff}`}>
        <div className="custom-container">
            <div className={styles.mgjhbdfg}>
                <h2 className="mb-4">{serviceResponse.data?.third_section_title &&
    ...
    <div className={`${styles.doieflmeoiwjrowe} pt-5`}>
        <div className="container-fluid px-5">
            <div className="idewhrwer_inner_wrapper mt-5">
                ...
                <div className="offset-lg-3 col-lg-9">
                    <div className="odijweirwerr_right bg-white">
                        <h2 className="mb-4">{serviceResponse.data?.fourth_section_title &&
            ...
            <div className="idewhrwer_inner_wrapper cdfbikerfsdfsfeeqwe mt-5">
    ...
    <div className="xnjhxffgdf">
        {serviceResponse.data?.sixth_section_image && (
            <img
                src={`${serviceResponse.image_url}/Template_8/${serviceResponse.data.sixth_section_image}`}
            />
        )}
    </div>
</main>
